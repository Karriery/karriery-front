...
export class FormComponent {
  ...
  packId : any ;
  packNumber : any
  constructor(private route: ActivatedRoute,private storage : AngularFireStorage,private reservationservice : ReservationService , private router : Router) { }
    ...
    .pipe(
      finalize(() => {
        fileref.getDownloadURL().subscribe((url : any) => {
          ...
          this.reservationservice.createReservation(obj).subscribe((res : any)=>{
            console.log(res);
           if(res.message){
            this.spinner = false
            Swal.fire({
            ...
            this.spinner = false
            this.router.navigate(["/payment"], { queryParams: {  id : res._id } });
           }
          })
